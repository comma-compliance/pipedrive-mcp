...
export const ActivitiesListSchema = z.object({
  ...
  due_date_from: z.string().optional().describe("Filter activities due from this date (YYYY-MM-DD)"),
  due_date_to: z.string().optional().describe("Filter activities due until this date (YYYY-MM-DD)"),
